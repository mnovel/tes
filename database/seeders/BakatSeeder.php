...
class BakatSeeder extends Seeder
{
    ...
    public function run(): void
    {
        $bakat = [
            [
                "name" => "Linguistik",
                "short_description" => "Paham struktur bahasa, senang berbicara, gemar mencatat",
                "full_description" => "Kecerdasan yang meliputi kemampuan mengolah kata secara efektif, baik secara lisan maupun tulisan. Seorang linguistik menikmati aktivitas yang melibatkan penggunaan kata, seperti membaca, menulis, berdiskusi, belajar bahasa asing. Biasanya, mereka terampil dalam meyakinkan/mempengaruhi orang lain ataupun berdebat. Selain itu, mereka juga dapat dengan mudah memahami ucapan orang lain. Kecerdasan ini biasanya berhubungan dengan mata pelajaran bahasa.",
            ...
            [
                ...
                "short_description" => "Berpikir logis, senang bekerja dengan angka, rasa keingintahuan tinggi",
            ...
            [
                "name" => "Visual Spasial",
                "short_description" => "Senang berimajinasi, kreatif, orientasi bentuk dan ruang yang baik",
            ...
            [
                "name" => "Interpersonal",
                "short_description" => "Senang berinteraksi dengan orang lain, Empati, Komunikasi yang Baik",
            ...
            [
                "name" => "Intrapersonal",
                "short_description" => "Menyadari diri dengan baik, reflektif, motivasi internal",
            ...
            [
                "name" => "Kinestetik",
                "short_description" => "Menyukai aktivitas fisik, Energi fisik tinggi, Peka terhadap sentuhan & tekstur",
                ...
                "recommendation" => "Jurusan yang berhubungan dengan kinestetik akan mengandalkan koordinasi tubuh yang baik, ketangkasan, dan kreativitas, terutama dalam pembuatan sebuah produk dan jasa serta pengoperasian alat. Kamu juga perlu memiliki fisik yang kuat serta kebugaran karena jurusan ini akan banyak melibatkan praktik. Pertimbangkan arah minatmu: apabila kamu lebih menyukai bidang seni gerak, maka jurusan seni dan keolahragaan akan cocok untukmu, jika kamu lebih suka bekerja secara teknis, maka jurusan yang cocok adalah antara teknik atau desain.",
                "icon" => null
            ],
            [
                "name" => "Naturalis",
                "short_description" => "Senang mengeksplorasi alam, peka terhadap lingkungan, menikmati interaksi dengan alam",
            ...
            [
                "name" => "Musikal",
                "short_description" => "Peka terhadap suara di sekitar, bernyanyi, senang mendengarkan musik",
                ...
                "recommendation" => "Jurusan yang berhubungan dengan musikal tentunya memilki kaitan erat dengan kemampuan mendengarkan, memahami, atau bahkan menciptakan musik sendiri. Maka sangat disarankan untuk terus berlatih, baik dalam bernyanyi, bermain alat musik, ataupun mengkreasikan sebuah musik. Kamu akan mempelajari beragam teknik musik, warna nada, dan penyusunan lagu. Hal ini tentunya akan bermanfaat jika kamu lebih menyukai bidang seni/hiburan, maka jurusan seni musik, komposer, atau bidang seni lainnya akan lebih cocok. Jika kamu lebih tertarik pada penerapan teori musik dalam pendidikan dan terapi, maka jurusan pendidikan musik atau terapi musik dapat menjadi pilihan.",
                "icon" => null
            ]
        ];
